# -*- coding: utf-8 -*-
"""time-series-anomaly-detection-ecg.ipynb
...
# rmsai_aenc_model_create.py
# Time Series Anomaly Detection using LSTM Autoencoders with PyTorch in Python
"""

!nvidia-smi

#!pip install -qq pandas liac-arff

#!pip install -qq arff2pandas # sganesh
!pip install scipy pandas torch
...
#%watermark -v -p numpy,pandas,torch,arff2pandas  # sganesh
...
from scipy.io import arff  # sganesh
...
# Decode byte strings to regular strings (if needed) for both DataFrames
...
# Shuffle the combined DataFrame (optional, as per your previous code)
